...
questo progetto mira ad creare un worm per farmi progredire nelle mie abilita di scrittore è  sopratutto per capire meglio
come difendersi da simili attacchi.

--

[*] **ATTENZIONE** questo codice non dovra mai essere usato per scopi immorali o contro la legalita infatti il sudetto creatore non prende nessuna responsabilita civile o legale 
per l'utilizzo che ne faranno altre persone, questo progetto si pone come lucro quello di imparare e di migliorarsi e non di dannegiare: persone, compagnie, stati inoltre
gli strumenti utilizzati sono per la maggiorparte scritti dal creato del Repo [lol1074 but for you BitCrucio] e anche i binari per i bypass.
...
|
+------------------------------------------------------------------------------------------------------------------------------------+
| src -> conterra tutti i file del worm ma non il worm infatti per il worm vero ed proprio si dovra entrare nella cartella           |
+---------------------------------------------------------------------------------------------------------------------+  \           | 
                                                                                                                       |   \         |
                                                                                                                       |   _init_    |
                                                                                                                       +-------------+       
 ...
 +----------------------------------------------------------------------------------------------------------------+
 | config -> si troveranno tutte le impostazioni sia della compilazione sia del worm                              |
 +----------------------------------------------------------------------------------------------------------------+


 +-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
 | bin -> tutti binari sia per le librerie mie personali per il worm ma anche i binari del worm per archietture come solarix ed macOS essendo molto più complesse da compilare |
 +-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
```
